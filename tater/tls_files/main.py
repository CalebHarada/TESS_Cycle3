...
class transitleastsquares(object):
    ...
    def power(self, **kwargs):
        ...
        # <ADDED BY CALEB HARADA 11/2021> ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        # Mask bad chi2 values in test statistics spectrum
        spectrum_msk = (test_statistic_residuals == len(self.y))
        test_statistic_periods = test_statistic_periods[~spectrum_msk]
        test_statistic_residuals = test_statistic_residuals[~spectrum_msk]
        test_statistic_rows = test_statistic_rows[~spectrum_msk]
        test_statistic_depths = test_statistic_depths[~spectrum_msk]
        # </ADDED BY CALEB HARADA 11/2021> ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
